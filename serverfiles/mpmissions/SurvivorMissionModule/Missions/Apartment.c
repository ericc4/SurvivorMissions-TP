class ApartmentMission extends SurvivorMissions {
    ...
    void ApartmentMission() {
        ...
        m_MissionMessage2 = "He told me that he has hidden money somewhere in the apartments. A few days ago he barricaded the whole building against the infected.";
        m_MissionMessage3 = "He used to live in one of the apartments\n** " + m_MissionLocationDir + " of " + m_MissionLocation + " **\nPlease check if " + SurvivorName + " is still alive. If not, then take his cash for yourself.";
    ...
    void SpawnObjects() {
        ...
        ItemBase MissionObject = ItemBase.Cast(GetGame().CreateObjectEx("Bear_Pink", m_MissionPosition, ECE_PLACE_ON_SURFACE));
        ...
        for (int i = 0; i < Barricades.Count(); i++) {
            ...
            Object PlankBarricade = GetGame().CreateObjectEx(BarricadeType, BarricadePos, ECE_PLACE_ON_SURFACE);
        ...
        Object phObject = GetGame().CreateObjectEx("Land_Boat_Small1", MissionBuilding.ModelToWorld("0.360 -7.410 6.730"), ECE_LOCAL);
    ...
    void SpawnAIs() {
        ...
        m_MissionAIs.InsertAt(GetGame().CreateObjectEx("ZmbF_JournalistNormal_White", InfGirlPos, ECE_PLACE_ON_SURFACE | ECE_INITAI), 1);
