class CityStoreMission extends SurvivorMissions { //CityStore is a copy of UrbanMall mission, it uses another secondary mission building
    ...
    override void ExtendMission() { //When player enters mission target zone at primary mission
        ...
        m_MissionMessage3 = "I have some cash for you at the small police station. Be careful, there might be bandits around " + m_MissionSecondaryLoc + ". They could intercepted our little radio talk here. Good luck!";
