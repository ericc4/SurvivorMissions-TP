class GanjaMission extends SurvivorMissions {
    ...
    override void ExtendMission() { //When player enters mission target zone at primary mission
        ...
        m_MissionMessage3 = "I have a reward for you at the gas station. Be carefull, there might be bandits on the way to " + m_MissionSecondaryLoc + ". They could intercepted our little radio talk here. Good luck and drive carefully!";
